...
const UserList = Loadable(lazy(() => import('views/administration/security/users/')));
const RoleList = Loadable(lazy(()=> import("views/administration/security/roles")));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/administration/access/privileges',
            element: <><PrivilegeList /></>
        },
        {
            path: '/administration/parametres/types',
            element: <TypeList />
        },
    ]
};
