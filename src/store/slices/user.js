...
const slice = createSlice({
    ...
    {
        builder.addCase(searchUsers.pending, )
    },
    reducers: {
        // HAS ERROR
...
export const searchUsers = createAsyncThunk("/users/search", (payload)=>
{
    return axios.get(`http://localhost:7000/users/open/search?key=${payload.key}`)
